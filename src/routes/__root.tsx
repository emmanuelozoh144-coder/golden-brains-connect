  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Golden Brains Youth Foundation" },
      {
        ...
        content:
          "Empowering young minds. Transforming communities. Partner, volunteer or collaborate with us.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Inter:wght@300;400;500;600;700&family=Inter+Tight:wght@400;500;600;700&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
